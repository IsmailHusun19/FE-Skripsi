                  ...
                  <section className="dark:bg-gray-900 w-full">
                    <div className="mx-auto max-w-screen-xl px-4 lg:px-12">
                      <div className="bg-white dark:bg-gray-800 relative shadow-md sm:rounded-lg overflow-hidden my-10">
                        <h1 className="font-semibold text-xl px-5">Feedback Mata Kuliah</h1>
                          ...
                          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                            ...
                            <tbody>
                              {matkul
                                ...
                                .map((matkul, index) => (
                                  <tr
                                  onClick={() => navigate(`/admin/pengguna/feedback mata kuliah/list-feedback/${matkul.id}`)}
                                    key={matkul.id}
                                  ...
                                  >
                                    ...
                                    <td className="px-4 py-3">{matkul.jumlahKuisioner}</td>
                                  </tr>
                                ))}
                            </tbody>
                          </table>
...
export default FeedBackMataKuliah;