...
const DetailFeedbackMataKuliah = () => {
        ...
        <>
          ...
          <div className="relative overflow-x-hidden">
            ...
            <div className="h-[calc(100vh-64x)] pb-5">
              <div
                className={`gap-3 mr-5 transition-all duration-300
    ${expanded ? "sm:ml-72" : "ml-20"}
    grid-cols-1 sm:[grid-template-columns:repeat(auto-fit,minmax(200px,1fr))]
  `}
              >
                <div className="w-full flex">
                  <div className="relative pt-[0px] min-h-screen transition-all duration-300 ease-in-out w-full">
                    <div
                      className={`flex-1 transition-all duration-300 ease-in-out min-h-screen flex justify-center ${
                        isSidebarCollapsed ? "" : "ml-16 lg:ml-64"
                      }`}
                    >
                      <div className="w-full pb-8 pt-6 border-t-4 border-blue-800 max-h-max rounded-md shadow-lg mt-10 mb-10 no-shadow print:border-none print:mt-[-20px]">
                        ...
                        <div className="mt-6 mx-4">
                          ...
                          <div className="flex gap-20">
                            <div className="mt-5">
                              ...
                              {Object.entries(skorMapping).map(
                                ([key, value]) => (
                            ...
                            <div className="mt-5 italic">
                              ...
                              <div>Rata - Rata 4.1 - 5 = Sangat Baik</div>
                              <div>Rata - Rata 3.1 - 4.0 = Baik</div>
                              <div>Rata - Rata 2.1 - 3.0 = Cukup</div>
                              <div>Rata - Rata 1.1 - 2.0 = Kurang</div>
                              <div>Rata - Rata 0 - 1.0 = Sangat Kurang</div>
                            </div>
                          </div>
                        </div>
                      </div>
...
export default DetailFeedbackMataKuliah;
